...
### Not yet tested — pending XLA compilation (18 ops)
...
inf2. With ~18 untested ops, compilation takes 2-3 hours total. Once compiled, results
are cached in `/var/tmp/neuron-compile-cache/` and subsequent runs are fast.

| Category | Ops | How to test |
|---|---|---|
| LLM ops (12) | add_rms_norm_dynamic_quant, scale_dynamic_quant, swiglu_dynamic_quant, moe_scatter_dynamic_quant, quant_matmul, moe_quant_group_gemm, moe_gather, head_rms_norm_dynamic_quant, rotary_embedding, store_kv_cache, dequant_kv_cache, flash_attention | Use workloads under `workloads/llm/test_ops/` |
